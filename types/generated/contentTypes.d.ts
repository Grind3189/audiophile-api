...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    gallery_images: Attribute.Relation<
      ...
      'api::gallery-image.gallery-image'
    >;
    categoryMobile: Attribute.Media;
    categoryTablet: Attribute.Media;
    categoryDesktop: Attribute.Media;
    included_items: Attribute.Relation<
      'api::product.product',
      'manyToMany',
      'api::included-item.included-item'
    >;
    category: Attribute.Enumeration<['speakers', 'headphones', 'earphones']>;
...
export interface ApiRecommendRecommend extends Schema.CollectionType {
